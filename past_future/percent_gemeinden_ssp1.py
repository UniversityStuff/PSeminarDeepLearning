...
results_csv_path = r"C:\Users\richt\Desktop\testNaturgefahrenOhneBuffer\prediction_modell\RESULT_SSP126.csv"
...
final_map_data.plot(
    ...
    legend_kwds={'label': "Anteil Hochrisiko-Fläche % (SSP126)", 'shrink': 0.6},
    edgecolor='black',
    linewidth=0.5,
    vmin=0,
    vmax=100
...
plt.title("Risikokarte Südtiroler Gemeinden 2100 (SSP126)", fontsize=16)
plt.axis('off')
plt.tight_layout()
plt.savefig('SSP126_Gemeinde_Risiko_Percent_Buffer.png', dpi=300)
plt.show()